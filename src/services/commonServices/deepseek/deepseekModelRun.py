...
async def deepseek_stream(configuration, apiKey):
    """Async generator yielding normalised delta dicts for DeepSeek chat.completions."""
    client = AsyncOpenAI(base_url=DEEPSEEK_BASE_URL, api_key=apiKey)
    config = {
        **configuration,
        "stream_options": {
            "include_usage": True,
